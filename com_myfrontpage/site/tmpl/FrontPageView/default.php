...
<div class="row">
	<div class="col">
		<div class="text-center">
			<h1>Welcome to Rad IQ Library!</h1>
...
<div class="row justify-content-center">
	<div class="col-10">
		<div>
			<p>
				Welcome to Rad IQ Library, a web-based application that aims to serve as a comprehensive resource for Medical
			...
			<p>
				At Rad IQ Library, we understand the importance of practical learning. That's why we have integrated self-assessment
			...
			<p>
				...
				in the field of medical imaging. Join us on this educational journey and unlock the possibilities that Rad IQ Library
				has to offer.
			</p>
		</div>
	</div>
